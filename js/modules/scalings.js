const SCALINGS = {
    ...
    infinity: {
        get amount() { return player.inf.infinities },
...
function getScalingStarts(id) {
    ...
    switch (id) {
        ...
        case "bh_tier": {
            if (hasInfinityUpgrade(7)) b[0] = Decimal.add(b[0],player.inf.infinities);
        }
        case "infinity": {
            if (hasElement(8)) b[0] = Decimal.add(b[0],3);
            if (hasElement(24)) b[0] = Decimal.add(b[0],12);
            if (hasElement(31)) b[0] = Decimal.add(b[0],5);
            if (hasElement(32)) b[0] = Decimal.add(b[0],10);
        }
    }
...
function getScalingPowers(id) {
    ...
    switch (id) {
        ...
        case "bh_tier": {
            if (hasElement(33)) b[0] = Decimal.mul(b[0],0.9);
