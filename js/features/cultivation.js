...
function updateCultivationHTML() {
    ...
    el('mining-tier-undo-btn').className = el_classes({locked: tier.eq(0), 'evo': true})
    el('mining-ascend-undo-btn').className = el_classes({locked: ascend.eq(0), 'evo': true})
    ...
    el('mining-tier-btn').className = el_classes({locked: CURRENCIES.stone.amount.lt(req), 'evo huge-btn': true})
    ...
    if (unl) {
        ...
        el('mining-ascend-btn').className = el_classes({locked: tier.lt(req), 'evo huge-btn': true})
    }
}
