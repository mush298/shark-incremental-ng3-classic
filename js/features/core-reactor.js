const CORE_REACTOR = [
...

    {
        ...
        require: l => l.pow_base(hasElement(12) ? 1.05 : 1.1).pow_base('e1000'),
        bulk: x => x.log('e1000').log(hasElement(12) ? 1.05 : 1.1),
        ...
        require: l => l.pow_base(hasElement(11) ? 1.05 : 1.1).pow_base('e2.5e6').pow10(),
        bulk: x => x.log10().log('e2.5e6').log(hasElement(11) ? 1.05 : 1.1),
...
function updateCoreHTML() {
    ...
    for (let i = 0; i < CORE_REACTOR.length; i++) {
        ...
        if (unl) {
            ...
            el(el_id+"div").className = el_classes({"core core-reactor-button": true, locked: !afford})
